...
echo_and_run cd "/home/boand/workspace_ros/src/ur5e_robotiq_gazebo/robotiq_85_gripper/robotiq_85_driver"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/boand/workspace_ros/build/ur5e_robotiq_gazebo/robotiq_85_gripper/robotiq_85_driver" \
    install \
    --root="${DESTDIR-/}" \
