...
echo_and_run cd "/home/boand/workspace_ros/src/ur5e_robotiq_gazebo/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/boand/workspace_ros/build/ur5e_robotiq_gazebo/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
